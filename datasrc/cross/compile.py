...
if gen_network_header:
	...
	print("#ifndef GAME_GENERATED_PROTOCOL6_H")
	print("#define GAME_GENERATED_PROTOCOL6_H")
...
""")
	...
	print("#endif // GAME_GENERATED_PROTOCOL6_H")
...
if gen_network_source:
	...
	lines += ['#include <engine/shared/protocol6.h>']
	lines += ['#include <engine/message.h>']
	lines += ['#include "protocol6.h"']

	lines += ['namespace protocol6 {']
