...
#pragma GCC diagnostic pop
	...
	curl_easy_setopt(pHandle, CURLOPT_USERAGENT, "Teeworlds " GAME_VERSION " (" CONF_PLATFORM_STRING "; " CONF_ARCH_STRING ")");
...
#pragma GCC diagnostic pop
	...
	{
		curl_easy_setopt(pHandle, CURLOPT_INTERFACE, Config()->m_Bindaddr);
	}
